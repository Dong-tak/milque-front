...
import { NonArrowWidgetTypes } from "@/lib/utils/arrowutils/arrowPath";
...
export default function Whiteboard() {
  ...
  //   // Command(Mac) 또는 Ctrl(Windows) 키가 려있을 때만 줌 동작
  //   if (e.metaKey || e.ctrlKey) {
  //     const delta = e.deltaY;
  //     const zoomFactor = Math.exp(-delta * ZOOM_SPEED);
  //     const newScale = Math.min(Math.max(scale * zoomFactor, 0.1), 5);
  ...
  useEffect(() => {
    ...
    // Call the function to update arrows when widgets change after the current call stack
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <div className="fixed bottom-8 left-1/2 z-50 h-11 -translate-x-1/2 rounded-lg border border-muted bg-white p-1 shadow-md">
